function HHMMSS(options) {
    ...
    hhmmss_s.addEventListener("click", function() {
        if(s_Click) {
            ...
            hhmmss_s.style.width = "2em";
            hhmmss_s.style.height = "1em";
            hhmmss_s.innerHTML = "";
    ...
    hhmmss_m.addEventListener("click", function() {
        if(m_Click) {
            ...
            hhmmss_m.style.width = "2em";
            hhmmss_m.style.height = "1em";
            hhmmss_m.innerHTML = "";
    ...
    hhmmss_h.addEventListener("click", function(e) {
        if(h_Click) {
            ...
            hhmmss_h.style.width = "2em";
            hhmmss_h.style.height = "1em";
            hhmmss_h.innerHTML = "";
