...
function draw() {
  ...
  var exactSeconds = nowTime.getHours() * 3600 + nowTime.getMinutes()*60 + nowTime.getSeconds() + nowTime.getMilliseconds()/1000 + 5;
  if(exactSeconds%3600 > 10)  {
    ...
    var newColor = color(
      lerp(red(bgColors[floor(exactSeconds/3600)-1]), red(bgColors[floor(exactSeconds/3600)]), percent),
      lerp(green(bgColors[floor(exactSeconds/3600)-1]), green(bgColors[floor(exactSeconds/3600)]), percent),
      lerp(blue(bgColors[floor(exactSeconds/3600)-1]), blue(bgColors[floor(exactSeconds/3600)]), percent)
    );
